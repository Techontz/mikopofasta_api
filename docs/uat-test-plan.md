...
| UAT-LON-025 | Loans | P1 | UAT-LON-024 passed | 1. Open `/ledger` or the journal for the disbursement entry | A balanced journal entry exists: **Dr Loan Receivable / Cr the Bank/Cash account chosen at preparation** (plus a Cr Fee Income line when a fee was withheld). Every line names the customer and loan. Debits equal credits, and the funding account's balance fell by the net payout. | | | | | |
